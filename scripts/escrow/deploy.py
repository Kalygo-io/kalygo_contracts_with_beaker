...
def main():
    ...
    app_client.create(
        ...
        glbl_escrow_1=100000,
        glbl_escrow_2=100000,
        glbl_total=200000,
        glbl_inspect_start_date=int(get_current_timestamp()),
        glbl_inspect_end_date=int(get_future_timestamp_in_secs(60)),
        glbl_inspect_extension_date=int(get_future_timestamp_in_secs(120)),
        glbl_closing_date=int(get_future_timestamp_in_secs(240)),
        glbl_closing_extension_date=int(get_future_timestamp_in_secs(300)),
        glbl_asa_id=12,
