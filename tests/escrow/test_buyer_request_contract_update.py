...
from modules.actions.escrow.buyer_request_contract_updt import (
...
from modules.actions.escrow.buyer_delete_contract_updt_box import (
...
record_codec_for_contract_update = ABIType.from_string(
    str(ContractUpdate().type_spec())
)
...
def test_buyer_request_contract_update(escrow_contract):
    ...
    for box in res["boxes"]:
        ...
        if box_name == "buyer_updt":
            ...
            membership_record = record_codec_for_contract_update.decode(
                base64.b64decode(box_value)
            )
